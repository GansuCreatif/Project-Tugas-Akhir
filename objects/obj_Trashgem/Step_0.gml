...
if (distance_to_player < 50) { // Sesuaikan jarak sesuai preferensi Anda
    ...
    if (!is_attacking) {
        ...
        sprite_index = spr_Trashgem_Attack; // Ganti sprite menjadi sprite serangan
    ...
    if (is_attacking) {
        ...
        sprite_index = spr_Trashgem_Idle; // Ganti sprite menjadi sprite berjalan
...
if (is_attacking) {
    ...
    if (image_index >= image_number - 1) {
        ...
        // Mengembalikan animasi berjalan
        sprite_index = spr_Trashgem_Walk; // Ganti sprite menjadi sprite berjalan
        image_speed = 0.1; // Kecepatan animasi berjalan
        image_index = 0; // Reset frame animasi berjalan
    } else {
