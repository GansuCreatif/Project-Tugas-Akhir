...
if (distance_to_player < 50) { // Sesuaikan jarak sesuai preferensi Anda
    ...
    if (!is_attacking) {
        ...
        sprite_index = Ace_Attack; // Ganti sprite menjadi sprite serangan
        ...
        obj_player.hp -= damage_ace; // Contoh: Mengurangi nyawa pemain sebanyak 1
    }
} else {
    ...
    if (is_attacking) {
        ...
        sprite_index = Ace_Walk; // Ganti sprite menjadi sprite berjalan
